...
public class Principal {
	...
	private static List<AgentController> createAgents(HashMap<String, ContainerController> containerList) {
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo1={"Explo2","Explo3","Explo4","Explo5","Explo6"};
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo2={"Explo1","Explo3","Explo4","Explo5","Explo6"};
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo3={"Explo1","Explo2","Explo4","Explo5","Explo6"};
		 ...
		 * AGENT Explo4
		 *********/
		//8/1) Get the container where the agent will appear
		c = containerList.get(ConfigurationFile.LOCAL_CONTAINER2_NAME);
		Assert.assertNotNull("This container does not exist",c);
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo4={"Explo1","Explo2","Explo3","Explo5","Explo6"};

		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentProjet.class.getName(), entityParametersExplo4);//ExploreSoloAgent
...
//		 * AGENT Explo5
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo5={"Explo1","Explo2","Explo3","Explo4","Explo6"};

		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentProjet.class.getName(), entityParametersExplo5);//ExploreSoloAgent
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersExplo6={"Explo1","Explo2","Explo3","Explo4","Explo5"};

		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentProjet.class.getName(), entityParametersExplo6);//ExploreSoloAgent
