...
public final class ConfigurationFile {
	...
	public static String INSTANCE_TOPOLOGY="resources/map2022-topologyExam.dgs";
	/**
	...
	//public static String INSTANCE_CONFIGURATION_ELEMENTS="resources/map2022-Gold-Diamond";
	public static String INSTANCE_CONFIGURATION_ELEMENTS="resources/map2022-elements";
