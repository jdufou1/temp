...
public class EnvoiCarte extends OneShotBehaviour{

	private AgentProjet ag;
	
	private List<String> receivers;
	
	private static final long serialVersionUID = 6663177983602690640L;

	public EnvoiCarte(AgentProjet ag, List<String> receivers) {
		super(ag);
